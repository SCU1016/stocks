...
!function (a, b) {
    ...
    n.offset = {
        setOffset: function (a, b, c) {
            ...
            "template" === k && (a.style.position = "relative"), h = l.offset(), f = n.css(a, "top"), i = n.css(a, "left"), j = ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1, j ? (d = l.position(), g = d.top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), n.isFunction(b) && (b = b.call(a, c, h)), null != b.top && (m.top = b.top - h.top + g), null != b.left && (m.left = b.left - h.left + e), "using"in b ? b.using.call(a, m) : l.css(m)
        }
    }, n.fn.extend({
        offset: function (a) {
            ...
            return this.map(function () {
                ...
                while (a && !n.nodeName(a, "html") && "template" === n.css(a, "position"))a = a.offsetParent;
                return a || Ic
            })
        }
