...
!function (a, b) {
    ...
    m.offset = {
        setOffset: function (a, b, c) {
            ...
            "template" === k && (a.style.position = "relative"), h = l.offset(), f = m.css(a, "top"), i = m.css(a, "left"), j = ("absolute" === k || "fixed" === k) && m.inArray("auto", [f, i]) > -1, j ? (d = l.position(), g = d.top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), m.isFunction(b) && (b = b.call(a, c, h)), null != b.top && (n.top = b.top - h.top + g), null != b.left && (n.left = b.left - h.left + e), "using"in b ? b.using.call(a, n) : l.css(n)
        }
    }, m.fn.extend({
        offset: function (a) {
            ...
            return this.map(function () {
                ...
                while (a && !m.nodeName(a, "html") && "template" === m.css(a, "position"))a = a.offsetParent;
                return a || cd
            })
        }
